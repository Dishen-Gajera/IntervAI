...
function Step3Report({ report }) {
    ...
    const questinScoreData = questionWiseScore.map((score, index) => {
        return {
            name: `Q${index + 1}`,
            score: score.score || 0
        }
    ...
    if (finalScore >= 8) {
        ...
        shortTagline = "Ecxcellent clearity and structured responses."
    } else if (finalScore >= 5) {
        performanceText = "Needs minor improvement before interviews.";
        shortTagline = "Good foundation, refine articulation.";
    } else {
        performanceText = "Singnificant improvement required.";
    ...
    const downloadPDF = async () => {
        ...
        doc.text(`Communication :${communication}`, margin + 10, currentY + 26);
        ...
        if (finalScore >= 8) {
            advice = "Excellent performance. Maintain confidence and structure. Continue refining clearity and supporting aanswers with strong real-world examples."
        } else if (finalScore >= 5) {
            advice = "Good foundation shown. Improve clearity and structure.Practice delivering concise, confident answers with stronger supporting example";
        } else {
            advice = "Significant improvement required. Focus on structured thinking, clearity and confident delivery. Practice answering aloud regularity.";
        }
    ...
    return (
        <div className='min-h-screen bg-linear-to-br from-gray-50 to-green-50 px-4  sm:px-6 lg:px-10 py-8'>
            <div className='mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4'>
                ...
                <button
                    onClick={downloadPDF}
                    className='bg-emerald-600 hover:bg-emerald-700 text-white py-3 px-2 rounded-xl shadow-md transition-all duration-300 font-semibold text-sm sm:text-base text-nowrap'>DownLoad PDf</button>
            </div>
                    ...
                    <motion.div className='bg-white rounded-2xl sm:rounded-3xl shadow-lg p-5 sm:p-8'>
                        ...
                        <div className='h-64 sm:h-72'>
                            ...
                            <ResponsiveContainer width="100%" height="100%">
                                ...
                                <AreaChart data={questinScoreData}>
                    ...
                    >
                        ...
                        <div className='space-y-6'>
                            {questionWiseScore.map((q, i) => {
                                return <div key={i} className='bg-gray-50 p-4 sm:p-6 rounded-xl sm:rounded-2xl border border-gray-200'>
                                    <div className='flex flex-col sm:flex-row sm:justify-between sm:items-start gap-3 mb-4'>
                                        <div>
                                            <p className='font-semibold text-gray-400'>Question {i + 1}</p>
