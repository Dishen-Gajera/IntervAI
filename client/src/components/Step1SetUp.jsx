        ...
        >
          ...
          <div className='space-y-6'>
            ...
            <select
              ...
              value={mode} className='w-full py-3 px-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-green-500 outline-none transition'>
...

            {
              ...
              <motion.div
                ...
                <p className='text-gray-600 font-medium overflow-hidden break-all'>{resumeFile ? resumeFile.name : "Click to upload resume (Optional)"}</p>
                ...
                {skills.length > 0 &&
                  <div>
                    ...
                    <div className='flex flex-wrap gap-2'>
                      ...
                      {
                        skills.map((s, i) => {
                          return <span className='bg-green-100 text-green-700 px-3 py-1 rounded-full text-sm' key={i}>{s}</span>
                        })
                      }
                    </div>
                  </div>
