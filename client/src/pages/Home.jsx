        ...
        <div className='max-w-6xl mx-auto'>
          ...
          <div className='text-center mb-28'>
            <motion.h1
              ...
              Practice Interview with <span className='relative inline-block'>
              ...
              [
                {
                  ...
                  step: "STEP 1",
                  title: "Role & Experiece Selection",
                ...
                return <motion.div
                  ...
                  className={`relative bg-white rounded-3xl border-2 border-green-100 hover:border-green-500 p-10 w-80 max-w-[90%] shadow-md hover:shadow-2xl
                              transition-all duration-300 ${index === 0 ? "rotate-[-4deg]" : ""}
                                         ${index === 1 ? "rotate-3 md:-mt-6 shadow-xl" : ""}  ${index === 2 ? "-rotate-3" : ""}
                                        
                                        `}>
                  <div className='absolute -top-8 left-1/2 -translate-x-1/2 bg-white border-2 border-green-500 w-16 h-16 rounded-2xl flex items-center justify-center shadow-lg'>
                    {item.icon}
                  </div>
                ...
                [
                  {
                    ...
                    desc: "Scores communication, technical accuacy and confidence."
                  },
                  {
                    image: resumeImg,
                  ...
                  return <motion.div
                    ...
                    <div className='flex flex-col md:flex-row items-center gap-8'>
                      ...
                      <div className='w-full md:w-1/2 flex justify-center'>
                        <img src={item.image} alt={item.title} srcset="" className='w-full h-auto object-contain max-h-64' />
                      </div>
                      <div className='w-full md:w-1/2'>
                        ...
                        <p className='text-gray-500 text-sm leading-relaxed'>{item.title}</p>
                      </div>
                    </div>
                  </motion.div>
                })
                ...
                [
                  {
                    ...
                    desc: "Behavioral and communication bases evaluation."
                  },
                  {
                    image: techImg,
                  ...
                  },
                  {
                    ...
                    desc: "Unloclpremium interview sessions easily."
                  }
                ].map((mode, index) => {
                  return <motion.div
                    initial={{ opacity: 0, y: 30 }}
                    ...
                    <div className='flex items-center justify-between gap-6'>
                      ...
                      <div className='w-1/2 flex justify-end'>
                        <img src={mode.image} alt={mode.title} srcset="" className='w-28 h-28 object-contain' />
                      </div>
                    </div>
                  </motion.div>
                })
